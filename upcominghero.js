...
function queuePlaylist(){ $(".display-browser").trigger("click"); setTimeout(function(){$(".playlist-564f9473bd566d23009ab305").trigger("click");},300); setTimeout(function(){$(".queue-playlist").trigger("click");},500); setTimeout(function(){$(".close-browser").trigger("click");},1000); }
function tooLong(){ 
	var mins = $(".min").html();
	var status = true;
	mins.replace('"', '');
